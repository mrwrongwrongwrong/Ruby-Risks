    ...
    submit() {
      ...
      if (this.round < this.boxNumber) {
        ...
        if (this.guessNumber <= currentBoxRuby) {
          ...
          this.gameResult += 'Congratulations, ' + this.currentPlayer + ' got ' + this.guessNumber + ' rubies from box ' + this.ideaBoxIndex + '.\n'
          ...
          this.gameResult += 'Sorry. ' + this.currentPlayer + ' get 0 ruby from box ' + this.ideaBoxIndex + '.\n'
        ...
        if (this.currentPlayer == 'AIPlayer') {
          ...
          if (aiGuessNumber <= currentBoxRuby) {
            ...
            this.gameResult += 'Congratulations, AI Player got ' + aiGuessNumber + ' rubies from box ' + aiIdeaBoxNumber + '.\n'
            ...
            this.gameResult += 'Sorry. AIPlayer got 0 ruby from box ' + aiIdeaBoxNumber + '.\n'
          }
          this.round += 1
    ...
    giveUp() {
      ...
      if (this.currentPlayer == 'AIPlayer') {
        ...
        if (aiGuessNumber <= currentBoxRuby) {
          ...
          this.gameResult += 'Sorry. AI Player got 0 ruby from box ' + aiIdeaBoxNumber + '.\n'
        }
        this.round += 1
        //whether game is finished
        if (this.round < this.boxNumber) {
